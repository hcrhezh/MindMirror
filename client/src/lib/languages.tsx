...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    voice: 'Voice',
    journalPlaceholder: 'Tell Dilshani how you\'re feeling today...',
    ...
    talkToSanasa: 'Talk to Dilshani',
    mood: 'Mood',
    thoughts: 'Thoughts',
    relations: 'Relations',
    dailyTips: 'Daily Tips',
    advancedMoodAnalytics: 'Advanced Mood Analytics',
    moodAnalyticsDescription: 'Visualize your mood patterns over time',
    last7Days: 'Last 7 Days',
    last30Days: 'Last 30 Days',
    last90Days: 'Last 90 Days',
    noMoodDataAvailable: 'No mood data available for this time period',
    moodTrends: 'Mood Trends',
    commonEmotions: 'Common Emotions',
    dayOfWeekAnalysis: 'Day of Week Analysis',
    weekdayPatterns: 'Weekday Patterns',
    ...
    topEmotionExplanation: 'is your most frequently experienced emotion during this period',
    emotionBalance: 'Positive vs Negative Balance',
    moodHighlights: 'Mood Highlights',
    averageMoodScore: 'Average mood score',
    highestMoodDay: 'Highest mood day',
    weekdayInsights: 'Weekday Insights',
    moodTrendTitle: 'Mood Trend Analysis',
    moodTrendUp: 'Improving trend +{percent}%',
    moodTrendDown: 'Declining trend -{percent}%',
    moodTrendStable: 'Stable trend',
    noMoodTrendData: 'Not enough data to analyze mood trends',
    bestDay: 'Best day',
    challengingDay: 'Most challenging day',
    weekdayTip: 'Understanding your weekday patterns can help you plan activities that boost your mood on challenging days.',
    sampleDataNotice: 'Sample visualization data is being shown. Add more mood entries to see your actual patterns.',
    noEmotionData: 'No emotion data available',
    noMoodDataByDay: 'No mood data available by day',
  ...
  si: {
    ...
    voice: 'හඬ',
    journalPlaceholder: 'අද ඔබ කොහොමද දැනෙන්නේ කියලා දිල්ශානිට කියන්න...',
    ...
    talkToSanasa: 'දිල්ශානි සමඟ කතා කරන්න',
    mood: 'මනෝභාවය',
    thoughts: 'සිතුවිලි',
    relations: 'සබඳතා',
    dailyTips: 'දෛනික ඉඟි',
  ...
  ta: {
    ...
    voice: 'குரல்',
    journalPlaceholder: 'இன்று உங்களுக்கு எப்படி உணர்கிறது என்பதை டில்ஷானியிடம் சொல்லுங்கள்...',
    ...
    talkToSanasa: 'டில்ஷானியுடன் பேசுங்கள்',
    mood: 'மனநிலை',
    thoughts: 'எண்ணங்கள்',
    relations: 'உறவுகள்',
  ...
  hi: {
    ...
    voice: 'आवाज़',
    journalPlaceholder: 'दिलशानी को बताएं कि आज आप कैसा महसूस कर रहे हैं...',
    ...
    talkToSanasa: 'दिलशानी से बात करें',
    mood: 'मूड',
    thoughts: 'विचार',
    relations: 'संबंध',
  ...
  es: {
    ...
    voice: 'Voz',
    journalPlaceholder: 'Dile a Dilshani cómo te sientes hoy...',
    ...
    talkToSanasa: 'Hablar con Dilshani',
    mood: 'Estado',
  ...
  ar: {
    ...
    voice: 'صوت',
    journalPlaceholder: 'أخبر ديلشاني كيف تشعر اليوم...',
